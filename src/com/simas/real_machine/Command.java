...
public class Command {
   ...
   * @throws IllegalArgumentException thrown when command couldn't be recognized or the arguments were invalid
   */
  @Nullable
  public static Command parse(@NotNull String string) throws IllegalArgumentException {
    final int[] args;
    ...
    throw new IllegalArgumentException("Unrecognized command from word: " + string);
  }
   ...
   * @throws IllegalArgumentException when type argument count doesn't match this word or when the arguments cannot be parsed into integers
   */
  @Nullable
  public static int[] extractArguments(@NotNull String string, Type type) throws IllegalArgumentException {
    ...
    if (type.argCount != arguments.length()) {
      throw new IllegalArgumentException(String.format("Invalid arguments detected for type %s. Word was %s", type, string));
    }
